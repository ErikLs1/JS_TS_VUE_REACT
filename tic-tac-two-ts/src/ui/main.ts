...
import {resetMoveTimer, startMoveTimer, stopMoveTimer} from "../gameBrain/Timer.ts";
import {renderBoard} from "./GameBoard.ts";
import {performAIMove} from "../ai/AiGameBrain.ts";

let currentGameMode: "HUMAN_VS_HUMAN" | "HUMAN_VS_AI" | "AI_VS_HUMAN" | "AI_VS_AI" = "HUMAN_VS_HUMAN";
...
function showLandingPage(): void {
    ...
    function createButton(text: string, mode: typeof currentGameMode) {
...
function showGameBoard(gameMode: typeof currentGameMode) {
...
function updateActionContainer(): void {
...
function showGridDirectionButtons(container: HTMLElement): void {
    container.innerHTML = "";
    const directions = [
        {label: "Up"},
        {label: "Down"},
